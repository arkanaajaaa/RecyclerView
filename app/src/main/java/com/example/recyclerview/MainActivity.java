...
public class MainActivity extends AppCompatActivity implements AbsenAdapter.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        absenItems.add(new AbsenItem("The Greatest Show", "5.02", "Pop Rock", R.drawable.tgs, "The Greatest Showman", "Lagu \"The Greatest Show\" oleh The Greatest Showman adalah lagu pembuka dari film The Greatest Showman yang penuh semangat dan menggambarkan kemegahan serta daya tarik dunia pertunjukan sirkus."));
